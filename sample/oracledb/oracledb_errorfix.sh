...
cp init.ora.720202525153 /opt/oracle/product/19c/dbhome_1/dbs/initorcl.ora

# 경로로 이동하지 않고, 전체경로로 입력 (full path)
cp /opt/oracle/admin/ORCL/pfile/init.ora.720202525153 /opt/oracle/product/19c/dbhome_1/dbs/initorcl.ora
...
/pot/oracle/product/19c/dbhome_1/network/admin/tnsnames.ora
